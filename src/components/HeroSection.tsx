...
import { BannerImage } from '@/components/banners/BannerImages';
    ...
    <div className="relative orange-gradient text-white py-24 overflow-hidden">
      ...
      <div className="relative max-w-6xl mx-auto text-center px-4">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8 animate-fade-in-up" style={{
          ...
          <div className="glass-effect rounded-2xl p-6 hover-lift overflow-hidden relative">
          ...
          <div className="glass-effect rounded-2xl p-6 hover-lift overflow-hidden relative" style={{
            animationDelay: '0.1s'
          }}>
            <div className="aspect-square mb-4 rounded-xl overflow-hidden relative">
              <BannerImage 
                imageId="beleza"
                className="w-full h-full"
                alt="Serviço de Beleza"
              />
            </div>
            <h3 className="text-xl mb-2 text-zinc-950 font-normal">Beleza</h3>
          ...
          <div className="glass-effect rounded-2xl p-6 hover-lift overflow-hidden relative" style={{
            ...
            <h3 className="text-xl mb-2 text-zinc-950 font-normal">Eletricista</h3>
