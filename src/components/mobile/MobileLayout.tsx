  ...
  return <div className="min-h-screen bg-gradient-to-br from-orange-50 to-white flex flex-col">
      ...
      <div className="fixed bottom-0 left-0 right-0 bg-white border-t border-gray-200 shadow-lg z-50">
        <div className="grid grid-cols-5 px-2 py-2">
          ...
          return <Button key={index} variant="ghost" className={`flex flex-col items-center justify-center h-16 rounded-lg transition-all duration-200 ${item.isActive ? 'bg-orange-50 text-orange-600 border border-orange-200' : 'text-gray-600 hover:text-orange-600 hover:bg-orange-50'}`} onClick={() => navigate(item.path)}>
