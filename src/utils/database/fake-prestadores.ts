...
export const fakePrestadores = [
  ...
  },
  {
    ...
    foto_url: 'https://api.dicebear.com/7.x/avataaars/svg?mouth=smile,serious,default&seed=Joana',
    avaliacoes_count: 55,
  ...
  // 5. CONSTRUÇÃO (Construção, Pintor)
  {
    ...
    foto_url: 'https://api.dicebear.com/7.x/avataaars/svg?mouth=smile,serious,default&seed=Marcos',
    avaliacoes_count: 73,
