...
export const categoryServiceNames: Record<string, string[]> = {
  ...
  reparos: ['Montador de móveis', 'Pedreiro', 'Encanador', 'Serviços Hidráulicos'],
...
export const categoryDescriptions: Record<string, string> = {
  ...
  reparos: 'Reparos gerais para sua casa ou escritório, incluindo serviços hidráulicos (encanador), montagem de móveis, pequenos consertos e manutenções.',
