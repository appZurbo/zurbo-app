...
const TrabalheConosco = () => {
  ...
  const servicos = [
    "Limpeza", "Jardinagem", "Pintura", "Elétrica", 
    "Encanamento", "Construção", "Beleza", "Informática",
    "Educação", "Saúde", "Transporte", "Eventos"
  ];
      ...
      <section className="py-20 px-4">
        <div className="max-w-6xl mx-auto text-center">
          ...
          <p className="text-xl md:text-2xl text-gray-600 mb-8 max-w-3xl mx-auto">
            Conecte-se com milhares de clientes em Sinop e região. 
            Cresça seu negócio com a plataforma líder em serviços.
          </p>
      ...
      <section className="py-20 px-4 bg-gradient-to-r from-orange-500 to-orange-600">
        <div className="max-w-4xl mx-auto text-center text-white">
          ...
          <Button 
            size="lg" 
            onClick={() => navigate('/auth')}
            className="bg-white text-orange-600 hover:bg-gray-50 text-lg px-8 py-6"
          >
            <Wrench className="mr-2 h-5 w-5" />
            Cadastrar-se agora como Prestador
            <ArrowRight className="ml-2 h-5 w-5" />
