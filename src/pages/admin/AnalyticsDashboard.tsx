...
const AnalyticsDashboard = () => {
    ...
    return (
        <div className="min-h-screen bg-gray-50/50 font-sans">
            ...
            <main className={`mx-auto max-w-7xl pb-20 pt-6 ${isMobile ? 'px-4' : 'px-8'}`}>

                {/* Header Section */}
                <section className="flex flex-col justify-between gap-4 sm:flex-row sm:items-center mb-6">
                    <div className="flex items-center gap-4">
                        <Button variant="ghost" size="sm" onClick={() => navigate('/admin')}>
                            <ArrowLeft className="h-4 w-4 mr-2" />
                            Voltar
                        </Button>
                        <div className="flex items-center gap-2 px-3 py-1 bg-white rounded-md border shadow-sm">
